...
const (
	Hello_SaveHello_FullMethodName   = "/user.Hello/SaveHello"
	Hello_DeleteHello_FullMethodName = "/user.Hello/DeleteHello"
	Hello_GetHello_FullMethodName    = "/user.Hello/GetHello"
	Hello_ListHello_FullMethodName   = "/user.Hello/ListHello"
)
