...
var CmdServer = &cobra.Command{
	...
	Long:  "Generate the proto server implementations. Example: eagproto proto server api/xxx.proto --target-dir=internal/service",
	Run:   run,
}
...
func run(_ *cobra.Command, args []string) {
	if len(args) == 0 {
		fmt.Fprintln(os.Stderr, "Please specify the proto file. Example: eagproto proto server api/xxx.proto")
		return
	}
